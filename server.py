...
from server_control import (
    build_control_bootstrap as _build_control_bootstrap,
    ...
    handle_control_stream as _handle_control_stream_impl,
...
def build_control_page(mesh: SovereignMesh) -> str:
    bootstrap = _build_control_bootstrap(mesh)
...
class OCPHandler(BaseHTTPRequestHandler):
    ...
    def _handle_mesh_mission_continuity_get(self, path: str):
        ...
        self._send_json(_get_mission_continuity_impl(self._mesh(), mission_id))
    ...
    def _handle_mesh_mission_continuity_export(self, path: str, data):
        ...
        self._send_json(_export_mission_continuity_impl(self._mesh(), mission_id, data))
    ...
    def _handle_mesh_mission_cancel(self, path: str, data):
        ...
        self._send_json(_cancel_mission_impl(self._mesh(), mission_id, data))

    def _handle_mesh_mission_resume(self, path: str, data):
        mission_id = path[len("/mesh/missions/"):-len("/resume")].strip("/")
        self._send_json(_resume_mission_impl(self._mesh(), mission_id, data))
    ...
    def _handle_mesh_mission_resume_from_checkpoint(self, path: str, data):
        ...
        self._send_json(_resume_mission_from_checkpoint_impl(self._mesh(), mission_id, data))

    def _handle_mesh_mission_restart(self, path: str, data):
        mission_id = path[len("/mesh/missions/"):-len("/restart")].strip("/")
        self._send_json(_restart_mission_impl(self._mesh(), mission_id, data))
    ...
    def _handle_mesh_job_cancel(self, path: str, data):
        ...
        self._send_json(_cancel_job_impl(self._mesh(), job_id, data))
